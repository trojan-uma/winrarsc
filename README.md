...
## 简介
>
> 从 5.40 正式版之后，WinRAR 的简体中文版代理商在「个人免费版」的程序中内置了即使购买了授权也无法去除的广告页面。<br>
...
## 关于 WinRAR 7.20 简体中文版的情况说明
>
> 截止到 2026 年 3 月 2 日，<https://www.rarlab.com/> 与 <https://www.win-rar.com/> 下载的简体中文版安装包（包名：winrar-x64-720sc.exe）没有启动广告，<http://www.winrar.com.cn/>
 下载的安装包（包名：winrarcn-1.4.0sc.exe）有启动广告。<br>
> 目前没有明确的信息表明该行为是官方的长期行为。
>
## 当前最新版本（7.20 版发布情况有变，暂不列入）
>
